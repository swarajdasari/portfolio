...
const Home = () => {
  return (
   <section id="home" className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black text-gray-100 flex items-center justify-center px-6 py-24">
  <div className="max-w-7xl w-full flex flex-col-reverse md:flex-row items-center gap-16">
    ...
    <div className="flex-1 text-center md:text-left space-y-6">
      ...
      <div className="flex justify-center md:justify-start space-x-6 text-3xl mt-4">
        <a href="https://in.linkedin.com/in/swaraj-dasari-60a647295" target="_blank" rel="noopener noreferrer">
          <FaLinkedin className="text-blue-500 hover:text-blue-400 transition duration-300" />
        </a>
        <a href="https://github.com/swarajdasari" target="_blank" rel="noopener noreferrer">
      ...
      <div className="flex flex-col sm:flex-row gap-4 mt-6 justify-center md:justify-start">
        <button className="bg-lime-500 hover:bg-lime-400 text-black font-semibold py-3 px-6 rounded-lg transition-all shadow-md">
          📄 View Resume
        </button>
        <button className="border-2 border-lime-500 text-lime-400 hover:bg-lime-500 hover:text-black py-3 px-6 rounded-lg transition-all shadow-md">
          👋 Let's Connect
        </button>
      </div>
    </div>
